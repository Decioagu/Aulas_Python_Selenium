...
class HomePage(BasePage):
    ...
    def exibir_mensagem_de_erro(self):
        assert self.encontrar_elemento(self.erro_field).text == 'Epic sadface: Username and password do not match any user in this service'
